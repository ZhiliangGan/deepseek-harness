...
来源：[`packages/interaction/guardian-approval/src/types.ts:34`](../packages/interaction/guardian-approval/src/types.ts)
...
来源：[`packages/notes/tool-notes/src/types.ts:90`](../packages/notes/tool-notes/src/types.ts)
...
来源：[`packages/structured-output/structured-output/src/types.ts:63`](../packages/structured-output/structured-output/src/types.ts)
...
来源：[`packages/structured-output/structured-output/src/types.ts:71`](../packages/structured-output/structured-output/src/types.ts)
