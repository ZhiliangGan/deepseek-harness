...
结构化输出域的类型：挂载的契约、持久结算与实时决策。[structured-output Agent Note](../../.agents/notes/implemented/feature/2026-08-22-structured-output-contracts.md) 拥有执行决策；本页记录 [`packages/structured-output/structured-output/src/types.ts`](../../packages/structured-output/structured-output/src/types.ts) 的确切字段。
...
Source: [`packages/structured-output/structured-output/src/index.ts:164`](../../packages/structured-output/structured-output/src/index.ts)
...
Source: [`packages/structured-output/structured-output/src/index.ts:58`](../../packages/structured-output/structured-output/src/index.ts)
