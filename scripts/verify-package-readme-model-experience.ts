...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/interaction/guardian-approval': { kind: 'none', reason: 'The auxiliary guardian-review request is invisible to the conversation; the reviewed agent\'s model-visible stream is unchanged.' },
  'packages/verifier/verifier': { kind: 'indirect', reason: 'The auxiliary judge request never joins the conversation; verdicts reach the model as the Consumer tool result.' },
  ...
  'packages/skill/skill-reasoning': { kind: 'indirect', reason: 'The bundled reasoning provider delegates model rendering to dsh-tool-skill.' },
