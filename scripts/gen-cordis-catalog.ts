...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  structuredOutput: 'structured-output.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  GoalChanged: 'goal.md',
  StructuredOutputArmed: 'structured-output.md',
  StructuredOutputContract: 'structured-output.md',
  StructuredOutputDecided: 'structured-output.md',
  StructuredOutputOutcome: 'structured-output.md',
  GoalRef: 'goal.md',
  GoalView: 'goal.md',
