---
description: "An LLM-review answerer on the approval/request waterfall that settles on-request approvals without interrupting the human, for users and maintainers choosing, configuring, or debugging the guardian."
...
- Design and contracts: [Agent Note: guardian approval answerer](../../../.agents/notes/implemented/feature/2026-08-22-guardian-approval-answerer.md).
