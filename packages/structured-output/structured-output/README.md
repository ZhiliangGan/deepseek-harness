---
description: "Structured-output contracts on the DeepSeek Harness conversation: one JSON Schema per turn, boundary validation, and bounded steering retries, for embedders and maintainers arming or debugging contracts."
...
- [Single owner and scope](#single-owner-and-scope)
...
- Design and contracts: [Agent Note: structured-output contracts](../../../.agents/notes/implemented/feature/2026-08-22-structured-output-contracts.md).
