...
| [`notes/`](notes/README.md) | The model-facing persistent working-notes tools | Product — stable API |
| [`structured-output/`](structured-output/README.md) | Structured-output contracts on the final reply | Product — stable API |
