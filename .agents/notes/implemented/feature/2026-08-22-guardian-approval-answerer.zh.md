...
一个可选包，[`packages/interaction/guardian-approval/`](../../../../packages/interaction/guardian-approval/README.zh.md)，在 waterfall 上注册一个 answerer。没有服务、没有注册表——缝已拥有请求、审计与 fail-closed 默认。
